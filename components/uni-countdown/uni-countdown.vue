<template>
	<view class="uni-countdown"  style="color: #fff;">
		...
		<view v-if="showDay" class="uni-countdown__splitor">天</view>
...
<style>
	...
	.proList .countdown .uni-countdown__number{background: #ff6e36!important;color: #fff!important;}
</style>